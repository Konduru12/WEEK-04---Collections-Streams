...
public class InsuranceApp {
    public static void main(String[] args) {
        List<InsurancePolicy> policies = Arrays.asList(
            new InsurancePolicy("P001", "Alice Smith", 1100),
            new InsurancePolicy("P002", "Bob Jones", 1800),
            new InsurancePolicy("P003", "Charlie Davis", 2200),
            new InsurancePolicy("P004", "Alice Brown", 950),
            new InsurancePolicy("P005", "David Smith", 2000),
            new InsurancePolicy("P006", "Eve Johnson", 1500)
        );
