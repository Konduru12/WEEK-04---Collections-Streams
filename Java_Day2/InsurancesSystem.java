...
public class InsurancesSystem {
    ...
    public static void main(String[] args) {
        InsurancesSystem system = new InsurancesSystem();
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        system.addPolicy(new InsurancePolicy("P101", "Abhinaya", LocalDate.parse("2025-05-10", formatter), "Health", 5000));
        system.addPolicy(new InsurancePolicy("P102", "Sasanka", LocalDate.parse("2025-04-27", formatter), "Auto", 3500));
        system.addPolicy(new InsurancePolicy("P103", "Venkat", LocalDate.parse("2025-04-20", formatter), "Home", 4000));
        system.addPolicy(new InsurancePolicy("P104", "Laxmi", LocalDate.parse("2025-06-15", formatter), "Health", 4500));
        system.displayAllPolicies();
        system.getPolicyByNumber("P102");
        system.listExpiringSoon();
        system.listByPolicyHolder("Abhinaya");
