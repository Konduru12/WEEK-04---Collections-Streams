...
public class BankingSystem {
    ...
    public void wthdrawalrequest(String acctNum, double amount) {
        queue.add(new WithdrawalRequest(acctNum, amount));
    }
    public void withdrawprocessing() {
        while (!queue.isEmpty()) {
    ...
    public static void main(String[] args) {
        ...
        bank.addAccount("A1B00", 500.0);
        bank.addAccount("B2C00", 300.0);
        bank.addAccount("C3D00", 800.0);
        bank.wthdrawalrequest("B200", 50);
        bank.wthdrawalrequest("A100", 600);
        bank.withdrawprocessing();
