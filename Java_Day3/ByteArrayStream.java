...
public class ByteArrayStream {
	public static void main(String[] args) {
        String inputImagePath = "lemon.jpeg";     
        String outputImagePath = "copied.jpg";      
        try {        
            byte[] imageBytes = readImage(inputImagePath);
            writeByteArray(imageBytes, outputImagePath);
    ...
    public static void writeByteArray(byte[] imageBytes, String outputPath) throws IOException {
