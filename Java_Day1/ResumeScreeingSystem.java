...
public class ResumeScreeingSystem{
    public static void main(String[] args) {
        Resume<SoftwareEngineer> se=new Resume<>(new SoftwareEngineer("Abhinaya",4));
        Resume<DataScientist> ds=new Resume<>(new DataScientist("Shasank",6));
        Resume<ProductManager> pm=new Resume<>(new ProductManager("Sasanka",true));
        se.display();
        ds.display();
        pm.display();
    }
